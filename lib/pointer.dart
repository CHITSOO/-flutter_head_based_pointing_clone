...
class Pointer {
  ...
  void updateFace(List<Face> faces,
      {required Size size, CameraLensDirection? direction}) {
  ...
  double calculateXFromCheeks() {
    ...
    Offset rightCheek =
        _face.getLandmark(FaceLandmarkType.rightCheek)!.position;
    if (rightCheek.dx < leftCheek.dx) {
      Offset temp = rightCheek;
